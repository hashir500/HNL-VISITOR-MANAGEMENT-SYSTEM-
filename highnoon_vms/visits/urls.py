...
urlpatterns = [
    ...
    path("visits/api/employees/", views.get_employees_by_branch, name="get_employees_by_branch"),
    ...
    path("backlogs/last-employee/<int:visitor_id>/", views.get_last_employee_for_visitor, name="get_last_employee_for_visitor"),
]